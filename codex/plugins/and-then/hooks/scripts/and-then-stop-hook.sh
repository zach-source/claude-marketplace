...
# Codex hands Stop hooks the final assistant turn directly, so read that instead
# of walking the transcript - the docs warn the transcript format is not a stable
# interface for hooks.
